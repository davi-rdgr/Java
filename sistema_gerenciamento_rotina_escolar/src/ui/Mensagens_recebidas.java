...
public class Mensagens_recebidas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Escrever uma mensagem");

        jButton2.setBackground(new java.awt.Color(0, 149, 214));
        jButton2.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Enviadas");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mensagens_recebidas().setVisible(true);
            }
        });
    }
